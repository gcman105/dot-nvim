...
class BaseExpression:
    ...
    def resolve_expression(self: _Self, query: Any = ..., allow_joins: bool = ..., reuse: Optional[Set[str]] = ..., summarize: bool = ..., for_save: bool = ...) -> _Self:
        ...
...
class CombinedExpression(SQLiteNumericMixin, Expression):
    ...
    lhs: Any = ...
    rhs: Any = ...
    def __init__(self, lhs: Combinable, connector: str, rhs: Combinable, output_field: Optional[_OutputField] = ...) -> None:
        ...
...
class OrderBy(BaseExpression):
    ...
    def __init__(self, expression: Combinable, descending: bool = ..., nulls_first: bool = ..., nulls_last: bool = ...) -> None:
        ...
...
class Case(Expression):
    ...
    default: Any = ...
    extra: Any = ...
    def __init__(self, *cases: Any, default: Optional[Any] = ..., output_field: Optional[_OutputField] = ..., **extra: Any) -> None:
        ...
    


class ExpressionWrapper(Expression):
    def __init__(self, expression: Union[Q, Combinable], output_field: _OutputField) -> None:
        ...
    


class Col(Expression):
    def __init__(self, alias: str, target: str, output_field: Optional[_OutputField] = ...) -> None:
        ...
...
class SimpleCol(Expression):
    ...
    def __init__(self, target: Field, output_field: Optional[_OutputField] = ...) -> None:
        ...
...
class Window(Expression):
    ...
    def __init__(self, expression: BaseExpression, partition_by: Optional[Union[str, Iterable[Union[BaseExpression, F]], F, BaseExpression]] = ..., order_by: Optional[Union[Sequence[Union[BaseExpression, F]], Union[BaseExpression, F]]] = ..., frame: Optional[WindowFrame] = ..., output_field: Optional[_OutputField] = ...) -> None:
        ...
