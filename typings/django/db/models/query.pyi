...
import datetime
from typing import Any, Collection, Dict, Generic, Iterable, Iterator, List, MutableMapping, Optional, Reversible, Sequence, Sized, Tuple, Type, TypeVar, Union, overload
...
class _BaseQuerySet(Generic[_T], Sized):
    model: Type[_T]
    query: Query
    def __init__(self, model: Optional[Type[models.Model]] = ..., query: Optional[Query] = ..., using: Optional[str] = ..., hints: Optional[Dict[str, models.Model]] = ...) -> None:
        ...
...
class BaseIterable(Sequence[_Row]):
    def __init__(self, queryset: _BaseQuerySet, chunked_fetch: bool = ..., chunk_size: int = ...) -> None:
        ...
...
class RawQuerySet(Iterable[_T], Sized):
    query: RawQuery
    def __init__(self, raw_query: Union[RawQuery, str], model: Optional[Type[models.Model]] = ..., query: Optional[Query] = ..., params: Tuple[Any] = ..., translations: Optional[Dict[str, str]] = ..., using: str = ..., hints: Optional[Dict[str, models.Model]] = ...) -> None:
        ...
