...
class Lookup(Generic[_T]):
    ...
    def batch_process_rhs(self, compiler: SQLCompiler, connection: DatabaseWrapper, rhs: Optional[OrderedSet] = ...) -> Tuple[List[str], List[str]]:
        ...
    ...
    def process_lhs(self, compiler: SQLCompiler, connection: DatabaseWrapper, lhs: Optional[Expression] = ...) -> Tuple[str, List[Union[int, str]]]:
        ...
...
class FieldGetDbPrepValueIterableMixin(FieldGetDbPrepValueMixin):
    ...
    def resolve_expression_parameter(self, compiler: SQLCompiler, connection: DatabaseWrapper, sql: str, param: Any) -> Any:
        ...
