...
class ModelState:
    ...
    def __init__(self, app_label: str, name: str, fields: List[Tuple[str, Field]], options: Optional[Dict[str, Any]] = ..., bases: Optional[Sequence[Union[Type[Model], str]]] = ..., managers: Optional[List[Tuple[str, Manager]]] = ...) -> None:
        ...
...
class ProjectState:
    ...
    models: Dict[Any, Any]
    real_apps: List[str]
    def __init__(self, models: Optional[Dict[Tuple[str, str], ModelState]] = ..., real_apps: Optional[List[str]] = ...) -> None:
        ...
