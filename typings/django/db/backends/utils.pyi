...
class CursorWrapper:
    ...
    def execute(self, sql: str, params: Optional[Union[Sequence[_SQLType], Mapping[str, _SQLType]]] = ...) -> Optional[Any]:
        ...
    
    def executemany(self, sql: str, param_list: Sequence[Optional[Union[Sequence[_SQLType], Mapping[str, _SQLType]]]]) -> Optional[Any]:
        ...
