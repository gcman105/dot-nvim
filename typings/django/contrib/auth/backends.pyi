...
UserModel: Any
class BaseBackend:
    def authenticate(self, request: Any, username: Optional[str] = ..., password: Optional[str] = ..., **kwargs: Any) -> Optional[AbstractBaseUser]:
        ...
...
class ModelBackend(BaseBackend):
    ...
    def with_perm(self, perm: Union[str, Permission], is_active: bool = ..., include_superusers: bool = ..., obj: Optional[Model] = ...):
        ...
