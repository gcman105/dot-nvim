...
from typing import Any, BinaryIO, Dict, Iterable, List, Mapping, Optional, Pattern, Set, Tuple, Type, TypeVar, Union, overload
...
class QueryDict(MultiValueDict[str, str]):
    encoding: str = ...
    _mutable: bool = ...
    def __init__(self, query_string: Optional[Union[str, bytes]] = ..., mutable: bool = ..., encoding: Optional[str] = ...) -> None:
        ...
    ...
    @classmethod
    def fromkeys(cls: Type[_Q], iterable: Iterable[Union[bytes, str]], value: Any = ..., mutable: bool = ..., encoding: Optional[str] = ...) -> _Q:
        ...
